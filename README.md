...
A Neovim plugin that lets you quickly explore types in .NET libraries. Noogle scans `bin` folder with [ILSpy](https://github.com/icsharpcode/ILSpy) and outputs methods and properties signatures of matching classes. It's avaliable on x64 Windows/Linux.
